...
config.set("fonts.statusbar", "18pt Cascadia Code")
config.set("fonts.tabs.selected", "18pt Cascadia Code")
config.set("fonts.tabs.unselected", "18pt Cascadia Code")
config.set("fonts.hints", "18pt Cascadia Code")
config.set("fonts.completion.entry", "18pt Cascadia Code")
config.set("fonts.completion.category", "18pt Cascadia Code")
