...
-- @param config Table containing window configuration options
-- @param focus Boolean indicating if the new window should gain focus
-- @return Table containing the created window and buffer handles
...
-- @param side String specifying the side ('below', 'right', etc.)
-- @param size Number defining the height or width of the new window
-- @param focus Boolean indicating if the new window should gain focus
-- @return Table containing the created window and buffer handles
...
-- @param win Window handle to delete
...
-- @param args Table containing arguments; expects `buf` for buffer-specific commands
...
-- @param args Table containing arguments; expects `buf` for buffer-specific mappings
